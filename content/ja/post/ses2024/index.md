...
藤田君は既発表論文トラックにて，ICSME2023で発表した["An Empirical Study on the Use of Snapshot Testing"](https://ieeexplore.ieee.org/document/10336316) を発表しました．
...
加藤君はポスター展示トラックで[「　タイトル　」]を発表しました．本研究は...
