...
白井君はポスター展示トラックで「Fuzzingカバレッジと脆弱性検出における関係性の考察」を発表しました．本研究はソフトウェアテストであるFuzzingのカバレッジと脆弱性の関係性について調査しています．今回の発表では，Fuzzingにおいて，(1) 累積回数とカバレッジに相関がないこと，(2) カバレッジと脆弱性の検出率は比例せず，逆相関が強いこと を報告しました．
